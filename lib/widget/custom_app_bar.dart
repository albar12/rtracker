  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      titleTextStyle: TextStyle(
        color: Theme.of(context).brightness == Brightness.dark ? AppColors.base : AppColors.textSheet,
        fontSize: Dimensions.size24,
        fontWeight: FontWeight.w700,
        fontFamily: 'Asap',
      ),
      leading: IconButton(
        onPressed: arrowBackTapped,
        icon: const Icon(Icons.arrow_back),
      ),
      iconTheme: IconThemeData(
        color: Theme.of(context).brightness == Brightness.dark ? const Color(0xFFFFFFFF) : const Color(0xFF323232),
      ),
      bottom: bottom,
      titleSpacing: 0,
      elevation: 0,
