...
class RangkumanPekerjaanState extends State<RangkumanPekerjaan>
    ...
    return BlocListener(
      ...
      listener: (context, state) {
        ...
        if (state is CopyFinished) {
          ...
          copyImageBloc.add(ReloadCopyImage());
        }
      },
  ...
  void fill() {
    ...
    copyImageBloc.add(CopyFinishedJoImage(jobOrder));
  }

  List<Widget> machineCondition(StartJobInitial state) {
    JobOrder jobOrder = widget.jobFormPageState.widget.jobOrder;
  ...
  List<Widget> cekPoi(StartJobInitial state) {
    JobOrder jobOrder = widget.jobFormPageState.widget.jobOrder;
